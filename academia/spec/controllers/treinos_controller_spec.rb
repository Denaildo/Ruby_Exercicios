...
describe TreinosController do
  ...
  let(:valid_attributes) { { "datainicio" => "2013-07-15" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested treino" do
        ...
        Treino.any_instance.should_receive(:update_attributes).with({ "datainicio" => "2013-07-15" })
        put :update, {:id => treino.to_param, :treino => { "datainicio" => "2013-07-15" }}, valid_session
      end
